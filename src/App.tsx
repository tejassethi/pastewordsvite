          ...
          <div className="h-full w-full flex flex-col justify-center items-center col-span-1">
            <div className="flex flex-col justify-center items-center">
              <div className="flex flex-col items-center lg:items-start">
                <p className="text-[#4f46e5] text-sm font-semibold bg-[#EFF2FF] border-2 border-[#4f46e5] px-2 mb-4">
                  Trusted by 10,000+ Users Worldwide
                </p>
                <div className="text-black text-6xl text-center lg:text-left font-extrabold relative lg:text-nowrap">
                  <p>Share files in 1 click.</p>
                  <p className="text-[#4f46e5] text-3xl lg:text-4xl lg:absolute lg:-bottom-10 lg:right-0 italic">
                    literally
                  </p>
                </div>
                <p className="text-[#525252] pt-2 lg:pt-0 text-center lg:text-left leading-7 w-full lg:w-3/4 ">
                  ...
                  {isLoading ? (
                    <div className="flex-1 h-10 w-full border text-black text-center border-gray-300 flex items-center justify-center">
                      <span className="mr-2 text-sm text-indigo-500">
                        {downloadedFile ? "Fetching File" : " Generating Words"}
                      </span>
                      <svg
